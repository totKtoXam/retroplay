          ...
          {panel === 'help' && (
            <div className="help-copy">
              <p>
                ...
                вращают камеру. F ставит камеру за персонажем. Alt + колесо
                меняет расстояние. Кнопка прицела включает необязательный захват
                мыши.
              </p>
              <p>
                <b>Краскомёт / конфетти:</b> слоты 1 и 2. ЛКМ стреляет туда,
                куда вы указываете. Краска исчезает через 12 секунд. Все игроки
                видят ваши залпы.
              </p>
              <p>
              ...
              <p>
                ...
                / встать. <b>Дважды C</b> — лечь. <b>Ctrl</b> — бег.{' '}
                <b>Shift</b> — медленный шаг.
              </p>
              <p>
              ...
              <p>
                В экономном режиме частота ограничена 30 FPS, без теневых карт.
                На устройстве без WebGL откроется обычная доска.
              </p>
            </div>
          )}
        </DialogContent>
