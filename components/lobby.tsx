      ...
      <Dialog open={help} onOpenChange={setHelp}>
        <DialogContent className="app-dialog">
          ...
          <div className="help-copy">
            <p>
              <b>В 3D:</b> нажмите «Управлять персонажем». WASD — движение,
              пробел — прыжок, C — сесть, дважды C — лечь. Ctrl — бег, Shift —
              медленный шаг. Мышь вращает камеру.
            </p>
            <p>
              <b>Инструменты:</b> цифры 1–0 и колесо мыши. Удерживайте среднюю
              кнопку для радиального меню. Подойдите к доске и нажмите E.
            </p>
            <p>
