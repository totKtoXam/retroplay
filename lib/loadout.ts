...
const SLOTS: Record<GameMode, Omit<Slot, 'key'>[]> = {
  ...
  // В «Предателе» оружия и доски нет: убийство, репорт и задания — действия режима, а в руках
  // только фонарик (индекс в GAME_TOOLS).
  impostor: [{ index: 13, label: 'Фонарик', hint: 'ЛКМ или F — включить и выключить' }],
};
